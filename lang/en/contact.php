                ...
                <div class='col-xs-12'>
                    <form class="form-horizontal" action='../../prueba.php'>
                        <div class="form-group">
                            <label for="inputName" class="col-xs-2 col-lg-2 control-label">Name</label>
                        ...
                        <div class="form-group">
                            <label for="inputSubject" class="col-xs-2 col-lg-2 control-label">Subject</label>
                            <div class="col-xs-9 col-lg-9">
                                <input name='name' type="text" class="form-control" id="inputSubject" placeholder="Subject">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputMessage" class="col-xs-2 col-lg-2 control-label">Message</label>
                            <div class="col-xs-9 col-lg-9">
